...
export const links = [
    ...
    links: [
      isAuthenticated()
        ? {
            ...
            Permission:
              data.data.adminDetails?.admin_permissions?.[0].dashboard,
          }
        : {
            name: 'ecommerce',
            title: 'Dashboard',
      ...
      isAuthenticated()
        ? {
            ...
            Permission:
              data.data.adminDetails?.admin_permissions?.[0].userManagement,
          }
        : {
            name: 'user',
            title: 'User Management',
      ...
      isAuthenticated()
        ? {
            ...
            Permission:
              data.data.adminDetails?.admin_permissions?.[0].adminManagement,
          }
        : {
            name: 'admin',
            title: 'Admin',
      ...
      isAuthenticated()
        ? {
            ...
            Permission:
              data.data.adminDetails?.admin_permissions?.[0]
...

  {
    title:
      isAuthenticated() &&
      data.data.adminDetails?.admin_permissions?.[0].systemConfiguration == 1
...

  {
    title:
      isAuthenticated() &&
      data.data.adminDetails?.admin_permissions?.[0].reportManagement == 1
        ? 'Report'
        : '',
